...
module.exports = (sequelize, DataType) => {
  const pcd_beneficio = sequelize.define('pcd_beneficio', {
    id_pcd_beneficio: {
      type: DataType.INTEGER,
      primaryKey: true,
      autoIncrement: true,
      xlabel: 'Id del pcd_beneficio',
    },
    fecha_inicio: {
    ...
    classMethods: {
      ...
      associate: (models) => {
        pcd_beneficio.belongsTo(models.pcd, {
          as: 'pcd',
          foreignKey: {
            name: 'fid_pcd',
            targetKey: 'id_pcd',
        ...
        pcd_beneficio.belongsTo(models.beneficio, {
          as: 'beneficio',
          foreignKey: {
            name: 'fid_beneficio',
        ...
        pcd_beneficio.belongsTo(models.tutor_ovt, {
          as: 'tutor_ovt',
          foreignKey: {
            name: 'fid_tutor_ovt',
    ...
    tableName: 'pcd_beneficio',
  });

  return pcd_beneficio;
};
