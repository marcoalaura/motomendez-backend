    ...
    up: (migration, DataTypes, done) => {
      ...
      $BODY$
           ...
           IF NOT EXISTS (SELECT id from tmp_corte_anual WHERE tipo = 'SIPRUN' and gestion = _gestion LIMIT 1) THEN
              ...
              t.grado_discapacidad, t.porcentaje_discapacidad, 'SIPRUN', 'HABILITADO', t.observacion_contrastacion, t.estado_contrastacion, _gestion , _idusuario, now()
              FROM tmp_pcd t 
           ...
           IF NOT EXISTS (SELECT id from tmp_corte_anual WHERE tipo = 'IBC' and gestion = _gestion LIMIT 1) THEN
              ...
              'MODERADO', 33, 'IBC', t.observacion_contrastacion, t.estado_contrastacion, _gestion , _idusuario, now()
              FROM tmp_pcd t
