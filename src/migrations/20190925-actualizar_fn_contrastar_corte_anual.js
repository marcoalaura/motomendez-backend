    ...
    up: (migration, DataTypes, done) => {
      ...
      $BODY$
                     ...
                     -- Comprobar lista de habilitados
                           ...
                           UPDATE tmp_corte_anual SET estado_contrastacion = 'PENDIENTE' WHERE gestion = _gestion;
                
                           -- Controla los casos donde el CI es vacio
                           ...
                           -- Habilitar a todos los usuarios registrados de la OVT
                           UPDATE tmp_corte_anual SET estado_contrastacion = 'HABILITADO' WHERE tipo in ('OVT', 'IBC') AND gestion = _gestion AND NOT(nro_documento = '' OR nro_documento IS NULL OR nro_documento = 'NULL')
                           and estado_contrastacion = 'PENDIENTE';
                ...
                INNER JOIN log_servicio_sigep l ON l.fid_pcd = d.id_pcd AND l.estado = 'ACTUALIZADO_SIGEP'
