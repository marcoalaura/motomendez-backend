...
module.exports = {
  up: (migration, DataTypes, done) => {
    const sql = (
      `
      CREATE OR REPLACE FUNCTION public.fn_retroactivo(
        _idusuario integer,
        _gestion integer)
      RETURNS text
      LANGUAGE plpgsql
            ...
            BEGIN
              ...
              LOOP
                ...
                LOOP
                  ...
                  -- Controlamos hasta el ultimo dia del mes
                  ...
                  ELSIF EXISTS (SELECT c.fid_pcd FROM certificado as c WHERE c.fid_pcd = ppcd.id_pcd AND c.tipo_certificado = 'IBC' AND c.fecha_vigencia >= make_date(_gestion, 12, 31)) THEN
